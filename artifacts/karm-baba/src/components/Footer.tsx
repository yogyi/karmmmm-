    ...
    <footer className="bg-secondary text-white mt-16">
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-10">
          ...
          <div>
            <h4 className="font-heading font-bold mb-4 text-white/90 text-sm uppercase tracking-wider">For Sellers</h4>
            <div className="space-y-2.5 text-sm text-white/60">
              {[
        ...
        <div className="pt-6 border-t border-white/15 flex flex-col sm:flex-row justify-between items-center gap-4 text-xs text-white/45">
          <div>© {new Date().getFullYear()} Karm Baba Technologies Pvt. Ltd. All rights reserved.</div>
