...
export const ListRfqsResponseItem = zod.object({
  ...
  "description": zod.string().nullish(),
  "status": zod.enum(['pending', 'responded', 'pending_confirm', 'accepted', 'rejected']),
  ...
  "status": zod.enum(['active', 'withdrawn', 'awarded', 'declined', 'pending_confirm']),
...
export const UpdateRfqBody = zod.object({
  "status": zod.enum(['pending', 'responded', 'pending_confirm', 'accepted', 'rejected']).optional(),
